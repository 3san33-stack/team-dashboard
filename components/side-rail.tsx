...
export function SideRail({ tasks }: Props) {
  ...
  return (
    <aside className="sticky top-6 hidden h-fit w-56 shrink-0 flex-col divide-y divide-border/60 self-start rounded-2xl border border-border/50 bg-foreground/[0.02] px-4 text-sm min-[1700px]:flex">
      <Section title="오늘">
